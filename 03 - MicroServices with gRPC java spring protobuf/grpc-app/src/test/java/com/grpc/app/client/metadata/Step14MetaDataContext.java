...
public class Step14MetaDataContext {
    ...
    public void balanceTest() throws InterruptedException {
        ...
        String basicOrPrime = ThreadLocalRandom.current().nextInt(1, 10) % 2 == 0 ? "prime": "basic";
        // thread sleeping
        ...
        try {
            Balance balance = this.blockingStub
                    .withCallCredentials(new UserSessionToken("user-token-ok-" + random + ":" + basicOrPrime))
